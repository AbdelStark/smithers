...
- [Debugging](/docs/guides/debugging) -- Dig deeper into failures using CLI and SQLite queries.
- [Events Reference](/docs/runtime/events) -- Full event type definitions.
- [Server Integration](/docs/integrations/server) -- Set up the HTTP server and SSE endpoint.
